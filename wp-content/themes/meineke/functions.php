...
function html5blank_header_scripts()
{
    if (!is_admin()) {
        ...
        wp_register_script('jqueryui','http://code.jquery.com/ui/1.10.3/jquery-ui.js?ver=1.10.', array(), '1.10.3'); // Modernizr
        ...
        wp_register_script('picturefill', get_template_directory_uri() . '/js/picturefill.js', array(), '1.0.0'); // Modernizr
        wp_enqueue_script('picturefill'); // Enqueue it!

        wp_register_script('matchmedia', get_template_directory_uri() . '/js/matchmedia.js', array(), '1.0.0'); // Modernizr
        wp_enqueue_script('matchmedia'); // Enqueue it!
...
function coupons() {
    ...
    register_taxonomy('coupons_category','coupons', array(
            'hierarchical' => true,
             'show_ui' => true,
            'query_var' => true,
    )); // add unique categories to shows section 

    $args = array(
            'label' => __('Coupons', 'agera'),
            'singular_label' => __('Coupon', 'agera'),
            'public' => true,
            'show_ui' => true,
